...
class ExhibitionPageWidget extends StatefulWidget {
  const ExhibitionPageWidget({
    Key? key,
  ...
  @override
  _ExhibitionPageWidgetState createState() => _ExhibitionPageWidgetState();
}

class _ExhibitionPageWidgetState extends State<ExhibitionPageWidget> {
